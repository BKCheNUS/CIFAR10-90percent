...
#optimizer = optim.SGD(ensemblemodel.parameters(), lr = learnrate, momentum = 0.9, weight_decay = 0.001)
...
anchored_text = AnchoredText('Trainset:{} Valset:{} Testset:{} \n lr:{} optim:{} activ:{}'.format(split2,(1-split2), split3, learnrate,OPTIM,activation),loc='upper left', prop = dict(fontweight = "normal", size= 10))
ax1.add_artist(anchored_text)
plt.savefig('cifar10_loss1')
